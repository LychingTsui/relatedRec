...
localDir=/data/tvapk/person/temp/relatedDated1225to0127
...
#XgbConvertRelatedItem2FeaturesFullJoinwithDateDiff 替换取对应处理的值
# ConvertRelatedItem2FeaturesFullJoinwithDateDiff
