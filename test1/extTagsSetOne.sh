...
$hadoop fs -rm -r $output
$hadoop jar ${jarPath}${jarName} com.qiguo.tv.movie.relatedRec.ExtMovieItemFeaturesTagSetOne  $input $output ${hdfs}relatedRecMovie $directStartId $mvTagsStartId $mvTagsIdxEnd ######???????????
...
sh /home/tvapk/run_sh/cuiliqing/relatedRec/extFeaturesTagsLevel.sh
