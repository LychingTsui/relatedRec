...
$hadoop jar  $jarPath$jarName com.qiguo.tv.movie.relatedRecXgModel.GetRelatedMovieClickRateClkN ${hdfs}relatedInput/ $output 
$hadoop fs -rm -r ${hdfs}relatedClickRateMvPair
$hadoop fs -cp $output/part-r-00000 ${hdfs}relatedClickRateMvPair 

$hadoop fs -rm -r $output 

$hadoop jar $jarPath$jarName com.qiguo.tv.movie.relatedRecXgModel.ConvertRelatedItem2FeaturesFullJoinClkN ${hdfs}relatedClickRateMvPair  $output ${hdfs}$movieItemFeatPath $joinTagsStart 
