...
$hadoop fs -rm -r $output
$hadoop jar ${jarPath}${jarName} com.qiguo.tv.movie.featCollection.GetMovieItem_features2 $input $output ${hdfs}relatedRecMovie $directStartId $mvTagsStartId $mvTagsIdxEnd ######???????????
...
sh /home/tvapk/run_sh/cuiliqing/relatedRec/extstep2.sh
