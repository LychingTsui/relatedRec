...
$hadoop jar $jarPath$jarName com.qiguo.tv.movie.relatedRec.ConvertRelatedItem2Features ${hdfs}relatedInput $output $hdfs$movieItemFeatPath  $tagsIdStart $joinTagsStart
