...
java -cp $jarPath$jarName com.qiguo.tv.movie.relatedRec.ConvertRelatedItem2FeaturesFullJoinWzArea ${dataSavePath}relatedInput/$movieItemFeatPath ${dataSavePath}relatedInput/posneg.txt ${dataSavePath}outdata.txt ${dataSavePath}relatedRecData/$fileidx
