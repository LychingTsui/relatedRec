...
java -cp $jarPath$jarName com.qiguo.tv.movie.relatedRec.ConvertRelatedItem2FeaturesJoinAreaTags ${dataSavePath}relatedInput/$movieItemFeatPath ${dataSavePath}relatedInput/posneg.txt ${dataSavePath}outdata.txt ${dataSavePath}$fileidx
